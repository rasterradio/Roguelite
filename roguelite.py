...
def handle_keys():
    ...
    if game_state == 'playing':
        ...
        #enable for thirst mechanic (used to be <=0)
...
death = Script("Die", "END")
death.breakable = False
...
townPony = Script("Shop", "A man guides you into a large, smoky tent. He has horses for sale.", lambda:None, {buyPony.name:buyPony}, True, {noPony.name})
...
discoverCave = Script("Explore", "The wind grows fierce. You take shelter in the cave for the night.", lambda:None, None, False, {noCave.name})
